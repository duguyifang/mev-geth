...
func (ethash *Ethash) Seal(chain consensus.ChainHeaderReader, block *types.Block, profit *big.Int, results chan<- types.SealResult, stop <-chan struct{}) error {
...
func (s *remoteSealer) makeWork(block *types.Block, profit *big.Int) {
	...
	if profit != nil {
		s.currentWork[10] = hexutil.EncodeBig(profit)
	}
